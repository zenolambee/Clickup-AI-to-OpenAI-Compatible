...
from gemini.client import ChatResult, GeminiChatClient
from gemini.config import Settings, load_account_from_env, load_settings
...
async def _ensure_models(client: GeminiChatClient) -> None:
...
def create_app(settings: Settings | None = None) -> FastAPI:
    ...
    def get_client() -> GeminiChatClient:
        ...
        return GeminiChatClient(account, base_url=settings.base_url)
